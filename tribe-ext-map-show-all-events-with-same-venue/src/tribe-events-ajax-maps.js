  ...
  $( document ).ready( function() {
    ...
    function tribe_generate_map_params() {
      ...
      if ( td.default_permalinks ) {
        if( !ts.params.hasOwnProperty( "post.type" ) ){
          ts.params["post.type"] = config.events_post_type;
        }
      ...
      $.post( GeoLoc.ajaxurl, ts.params, function( response ) {
        ...
        if ( response.success ) {
          ...
          */
          ...
          var marker_filter = [];
          marker_filter = response.markers;
          var filteredTgMarkers;
          filteredTgMarkers = FilterMarkers(marker_filter);
