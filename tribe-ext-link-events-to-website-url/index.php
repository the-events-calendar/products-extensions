<?php
/**
 * Plugin Name:     The Events Calendar: Link Event Titles to Event Website URLs
 * Description:     An extension that makes event titles link to the events' Website URLs when present.
 * Version:         1.0.0
 * Extension Class: Tribe__Extension__Link_Event_Titles_to_Event_Website_URLs
...
class Tribe__Extension__Link_Event_Titles_to_Event_Website_URLs extends Tribe__Extension {
